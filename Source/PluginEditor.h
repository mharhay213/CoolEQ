...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<NewProjectAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<NewProjectAudioProcessor::BlockType>* leftChannelFifo;
