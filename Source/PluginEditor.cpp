                                   ...
                                   juce::Slider &slider) 
{
    ...
    g.setColour(Colour(95u, 95u, 95u));
...
//==============================================================================
ResponseCurveComponent::ResponseCurveComponent(NewProjectAudioProcessor& p) : 
audioProcessor(p),
...
void ResponseCurveComponent::resized()
{
    ...
    for (auto gDb : gain) {
        ...
        g.setColour(gDb == 0.f ? Colour(255u, 154u, 1u) : Colours::dimgrey);
...
//    bounds.reduce(9, //JUCE_LIVE_CONSTANT(5)
//                  9); //JUCE_LIVE_CONSTANT(5)
